...
_14.empty().append($("<div class=\"menu-test\"></div>").html(_15.text));
if(_15.iconCls){
...
$(this).find(".menu-test").css({height:(_19.itemHeight-2)+"px",lineHeight:(_19.itemHeight-2)+"px"});
});
...
_1d=0;
_18.find("div.menu-test").each(function(){
...
_67.text=_66.text;
$(_66.target).children("div.menu-test").html(_66.text);
});
