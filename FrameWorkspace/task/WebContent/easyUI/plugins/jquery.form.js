...
var _6=$(_2).find(".textbox-test:focus");
...
if($.fn.validatebox){
var t=$(_49);
t.find(".validatebox-test:not(:disabled)").validatebox("validate");
...
_4d.novalidate=_4c;
$(_4b).find(".validatebox-test:not(:disabled)").validatebox(_4c?"disableValidation":"enableValidation");
};
...
return jq.each(function(){
$(this).find(".validatebox-test:not(:disabled)").validatebox("resetValidation");
});
