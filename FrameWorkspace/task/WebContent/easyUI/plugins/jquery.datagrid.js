...
var ss=["<style type=\"test/css\" easyui=\"true\">"];
...
_6f.css("test-align",(col.halign||col.align||""));
...
var vbox=tr.find(".validatebox-test");
...
var _1bb=$("<input type=\"test\" class=\"datagrid-editable-input\">").appendTo(_1b9);
...
var _1d4=$("<input type=\"test\" class=\"datagrid-editable-input\">").appendTo(_1d2);
