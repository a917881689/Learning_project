...
var _4=$("<span class=\"textbox\">"+"<input class=\"textbox-test\" autocomplete=\"off\">"+"<input type=\"hidden\" class=\"textbox-value\">"+"</span>").insertAfter(_3);
var _5=$(_3).attr("name");
if(_5){
...
tb.find(".textbox-test").remove();
if(_9.multiline){
$("<textarea id=\""+_a+"\" class=\"textbox-test\" autocomplete=\"off\"></textarea>").prependTo(tb);
}else{
$("<input id=\""+_a+"\" type=\""+_9.type+"\" class=\"textbox-test\" autocomplete=\"off\">").prependTo(tb);
}
$("#"+_a).attr("tabindex",$(_7).attr("tabindex")||"").css("test-align",$(_7).css("test-align"));
...
tb.find(".textbox-test").validatebox("destroy");
tb.remove();
$(_10).remove();
};
...
_47.find(".textbox-test").attr("id",_48);
...
return $.data(jq[0],"textbox").textbox.find(".textbox-test");
},button:function(jq){
