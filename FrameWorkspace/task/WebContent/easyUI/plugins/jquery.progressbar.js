...
$(_2).html("<div class=\"progressbar-test\"></div><div class=\"progressbar-value\"><div class=\"progressbar-test\"></div></div>");
...
_8._size(_7);
_8.find("div.progressbar-test").css("width",_8.width());
_8.find("div.progressbar-test,div.progressbar-value").css({height:_8.height()+"px",lineHeight:_8.height()+"px"});
};
...
$(this).find("div.progressbar-test").html(_10);
if(_11!=_e){
